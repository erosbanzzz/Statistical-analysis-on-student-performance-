...
```{r tabla1 , echo=FALSE, fig.table = 'htbp'}
...
```{r grafico1, echo=FALSE, fig.pos = 'htbp', fig.width = 9, fig.height = 4}
ggplot(SP, aes(x = parental_level_of_education, y = Desempeño, fill = parental_level_of_education)) + geom_boxplot()  + labs(title = "Desempeño en función del Nivel Educativo de los Padres", x = "Nivel Educativo de los Padres", y = "Desempeño") + theme(text = element_text(family = "serif")) + theme(plot.title = element_text(hjust = 0.5)) + theme(axis.text.x = element_blank())
```


```{r tabla2 , echo=FALSE, table.pos = 'htbp'}
...
```{r grafico2, echo=FALSE, fig.pos = 'htbp', fig.width = 9, fig.height = 4}
ggplot(SP, aes(x = lunch, y = Desempeño, fill = lunch)) + geom_boxplot()  + labs(title = "Desempeño en función del la Calidad de los Almuerzos", x = "Almuerzo", y = "Desempeño") +  theme(text = element_text(family = "serif")) + theme(text = element_text(family = "serif")) + theme(plot.title = element_text(hjust = 0.5)) + theme(axis.text.x = element_blank())
```

```{r grafico3, echo=FALSE, fig.pos = 'htbp', fig.width = 9, fig.height = 4}
ggplot(SP, aes(x = parental_level_of_education, y = Desempeño, fill = lunch)) + geom_boxplot()  + labs(title = "Desempeño en función del Nivel Educativo de los Padres", x = "Nivel Educativo de los Padres", y = "Desempeño") + theme(text = element_text(family = "serif")) + theme(plot.title = element_text(hjust = 0.5)) + theme(axis.text.x = element_blank())             
```
