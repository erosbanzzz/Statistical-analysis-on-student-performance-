...
En esta tabla lo primero que slta a la vita es que a medida que el nivel educativo de los padres aumenta, la cantidad de estudiantes en los rangos de Desempeño más altos también tiende a aumentar, por ejemplo, en el rango [78,100], los niveles educativos "associate's degree", "bachelor's degree" y "master's degree" tienen 63, 38 y 24 estudiantes respectivamente, en comparación con "high school" que tiene solo 28, sin embargo busquemos visualizar ésto mejor haciendo el uso de cuartiles y un diagrama de cajas.
