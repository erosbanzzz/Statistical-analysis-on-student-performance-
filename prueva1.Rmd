...
cat("\\textbf{Tabla de frecuencias bivariante: Desempeño En Comparación al Nivel Educativo de los Padres}\n")
kable(tabla_frecuenciasa_df, format = "latex", booktabs = TRUE) %>%
  kable_styling(latex_options = c("striped", "hold_position"))

# Reducir el espacio entre las tablas
cat("\\vspace{-10mm}")  # Ajusta este valor para reducir el espacio entre las tablas
...
# Crear la tabla formateada
cat("\\textbf{Tabla de frecuencias bivariante: Desempeño En Comparación al Tipo de Almuerzo}\n")
kable(tabla_frecuenciasb_df, format = "latex", booktabs = TRUE) %>%
  kable_styling(latex_options = c("striped", "hold_position"))
```
