...
for (i in niveles_educativos) {
  datos_nivel <- variables %>% filter(`parental level of education` == i)
  
  # Crear el histograma con ggplot2
  histograma <- ggplot(datos_nivel, aes(x = Desempeño)) +
    geom_histogram(aes(y = ..density..), binwidth = 10, fill = "lightblue", color = "black") +
    geom_density(color = "red", size = 1) +
    labs(title = paste("Histograma de Desempeño para", i),
         x = "Desempeño",
         y = "Densidad") +
    theme_minimal()
